...
public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        Person1 p1 = new Person1("Rishi Raj");
        toPrint += p1.toString("rraj9");
        //Person2 replace P2 with your name
        //and gburdell with your gt id
        Person2 p2 = new Person2("Jan Risse");
        toPrint += p2.toString("jrisse3");
        //Person3 replace P3 with your name
        //and gburdell3 with your gt id
        Person3 p3 = new Person3("Beau Mitchell");
        toPrint += p3.toString("bmitchell48");
        //Person4 replace P4 with your name
        //and gburdell4 with your gt id
        Person4 p4 = new Person4("Kevin Lun");
        toPrint += p4.toString("klun3");
        //Person5 replace P4 with your name
        //and gburdell5 with your gt id
        Person5 p5 = new Person5("Guillaume Noziere");
        toPrint += p5.toString("gnoziere3");
